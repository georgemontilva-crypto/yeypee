            ...
            {commonChars.length ? (
              <>
                {commonChars.map((ch: any) => (
                  ...
                  >
                    <div className="flex items-center justify-center p-1 sm:p-2 aspect-square md:aspect-auto md:h-52">
                      {ch.imageFront ? (
                        <img src={ch.imageFront} alt={ch.name} className="h-full w-full object-contain scale-[1.28]" />
                      ) : (
                ...
                >
                  <div className="flex items-center justify-center p-1 sm:p-2 aspect-square md:aspect-auto md:h-52 gold-pulse">
