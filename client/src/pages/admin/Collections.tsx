...
const FIELDS = [
  ...
  { key: "cardImage", label: "Card Image", type: "media" },
...
const COLUMNS = [
  ...
  { key: "status", label: "STATUS", render: (v: string) => (
    <span className={`text-xs font-bold px-2 py-1 rounded-md ${v === "live" ? "bg-green-100 text-green-700" : "bg-yellow-100 text-yellow-700"}`}>{v === "coming_soon" ? "COMING SOON" : "LIVE"}</span>
  ) },
