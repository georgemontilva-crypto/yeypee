...
const CONTENT_SLOTS: ContentSlot[] = [
  {
    ...
    where: "Banner at the top of the collection page.",
    spec: "Horizontal, 2000 x 900 px or wider.",
  ...
  },
  {
    ...
    where: 'The /collections list banner AND the round shortcut in "Explore our worlds".',
    spec: "Horizontal strip, around 2400 x 480 px, with the character roughly centred so the circle crops it well.",
    to: "/admin/collections",
    module: "Collections",
  },
  {
