...
const CONTENT_SLOTS: ContentSlot[] = [
  {
    ...
    where: "Banner at the top of the collection page AND the round shortcut in \"Explore our worlds\".",
    spec: "Put the character centred: the circle crops a square out of the middle.",
  ...
  },
  {
    ...
    where: "The wide banner of each collection in the /collections list.",
    spec: "Horizontal strip, around 2400 x 480 px. It is cropped to a fixed height, anchored to the right.",
    to: "/admin/collections",
    module: "Collections",
  },
  {
