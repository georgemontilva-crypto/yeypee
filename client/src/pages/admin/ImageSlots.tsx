...
const CONTENT_SLOTS: ContentSlot[] = [
  {
    ...
    where: "Wide banner: the /collections list and the top of the collection page.",
    spec: "Horizontal strip, around 2400 x 480 px.",
  ...
  },
  {
    ...
    where: 'The round shortcut in "Explore our worlds" on the homepage.',
    spec: "Square, around 1000 x 1000 px, with the character centred.",
    to: "/admin/collections",
    module: "Collections",
  },
  {
