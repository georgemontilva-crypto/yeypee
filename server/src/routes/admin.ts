...
const collectionSchema = z.object({
  ...
  statCountValue: z.string().max(40).nullable().optional(),
...
router.get("/settings", async (req: AuthedRequest, res) => {
  ...
  const mediaKeys = [
    ...
    "popup_image_asset_id",
    "page_about_image_1_asset_id",
    "page_about_image_2_asset_id",
    "page_about_image_3_asset_id",
    "page_contact_image_1_asset_id",
